...
def attack(char_name: str, char_class: str) -> str:
    """Return damage depending on the selected character class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return defense depending on the selected character class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return a special skill depending on the character's class."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """
    Select character's class and allows you to select a method of influence.
    Also accepts input commands.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Allow you to select a character class."""
    approve_choice: str = ''
    char_class: str = ''
